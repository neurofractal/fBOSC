...
%% Start fBOSC
start_fBOSC
cd('/Users/rseymoue/Documents/GitHub/fBOSC/simulate');
...
for c = 1:length(condition)
    for o = 1:length(oscillations)
        ...
        [aperiodic_out, ...
            osc, ...
            data_out, ...
            osc_array]              = sim_fBOSC(cfg,500,aperiodic);
        
        % Combine all trials into one array
        data_comb_osc       = zeros(cfg.trial,(cfg.time*500));
        for i = 1:cfg.trial
...
for c = 1:length(condition)
    ...
    cfg                         = [];
    cfg.freq                    = 4;
    cfg.amplitude               = 50; % SNR of the simulated oscillation
    ...
    cfg                         = [];
    cfg.freq                    = 10;
    cfg.amplitude               = 140; % SNR of the simulated oscillation
